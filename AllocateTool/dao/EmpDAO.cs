...
namespace AllocateTool.dao
{
    public partial class EmpDAO : BaseDAO<Emp>
    {
        ...
        public Emp FindEmpByIdDAO(OleDbConnection conn,int id) {
            ...
            string sqlStr = @"SELECT e1.m_id as m_id,e1.m_name as m_name,e1.m_title as m_title,e1.m_login as m_login,e1.m_statue as m_statue,e1.m_mgid as m_mgid,e2.m_name as m_leaderName,e1.m_station as m_station,e1.m_keyword as m_keyword,e1.m_isAutoAsign as m_isAutoAsign FROM emps e1 left join emps e2 on e1.m_mgid=e2.m_id WHERE e1.m_id=@M_id;";
        ...
        public void AddEmpItemDAO(OleDbConnection conn, Emp emp)
        {
            ...
            string sqlStr = @"INSERT INTO emps(m_name,m_title,m_login,m_statue,m_mgid,m_station,m_keyword,m_isAutoAsign) VALUES(@M_Name,@M_title,@M_login,@M_statue,@M_mgid,@M_station,@M_keyword,@M_isAutoAsign);";
        ...
        public void UpdateEmpItemDAO(OleDbConnection conn, Emp emp) {
            string sqlStr = @"UPDATE emps SET m_name=@M_name,m_title=@M_title,m_login=@M_login,m_statue=@M_statue,m_mgid=@M_mgid,m_station=@M_station,m_keyword=@M_keyword,m_isAutoAsign=@M_isAutoAsign WHERE m_id=@M_id";
        ...
        public List<Emp> FindAllEmpDAO(OleDbConnection conn) {
            //string sqlStr = @"SELECT e1.m_id as m_id,e1.m_name as m_name,e1.m_title as m_title,e1.m_login as m_login,e1.m_statue as m_statue,e1.m_mgid as m_mgid,e2.m_name as m_leaderName,e1.m_station as m_station,e1.m_isAutoAsign as m_isAutoAsign FROM emps e1 left join emps e2 on e1.m_mgid=e2.m_id;";
            string sqlStr = @"SELECT * FROM emps;";
