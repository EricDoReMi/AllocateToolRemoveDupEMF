...
namespace AllocateTool.Entity
{
    public partial class Emp
    {
        ...
        public static int nextRequestEmpId = 1;
        public Emp() {
            M_name = "";
            M_login = "0";
            M_statue = "1";
        ...
        //是否接受自动分配case,0不接受,1接受
        public int? M_isAutoAsign { get; set; }
        ...
        public OleDbParameter[] ToInsertByParamArray()
        {
            OleDbParameter[] param = new OleDbParameter[] {
                ...
                new OleDbParameter("@M_isAutoAsign",EntityUtils.SqlNull(M_isAutoAsign))
            };
